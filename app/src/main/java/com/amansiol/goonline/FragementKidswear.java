...
public class FragementKidswear extends Fragment {

    RecyclerView categoriesRecycler;
    CategoryAdapter categoryAdapter;
    ArrayList<Category> categories;
    String[] categoryNames = {"Casual","Party Wear"};
    int[] categoryImages = {R.drawable.normal, R.drawable.download};
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_fragement_kidswear, container, false);
